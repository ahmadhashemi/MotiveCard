...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        if (fontName != nil) {
            ...
            [self.titleLabel setFont:[UIFont fontWithName:@"IRANSans" size:15]];
        ...
        if ([subtitle length])
        {
            ...
            if (fontName != nil) {
                ...
                [self.contentLabel setFont:[UIFont fontWithName:@"IRANSans" size:12]];
        ...
        if (image)
        {
            ...
            self.iconImageView.frame = CGRectMake(screenWidth - padding * 2 - image.size.width,
                                                  padding,
                                                  image.size.width,
                                                  image.size.height);
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    self.titleLabel.frame = CGRectMake(screenWidth - self.textSpaceLeft - self.titleLabel.frame.size.width,
                                       padding,
    ...
    {
        self.contentLabel.frame = CGRectMake(screenWidth - self.textSpaceLeft - self.contentLabel.frame.size.width,
